                    ...
                    <div>
                      ...
                      <div
                        ...
                        className={`border-2 border-dashed rounded p-6 text-center transition-all ${
                          isFieldDisabled
                            ? "border-slate-200 bg-slate-100 text-slate-400 cursor-not-allowed opacity-65"
                            : dragActive 
                      ...
                      >
                        ...
                        <p className="text-[10px] text-slate-400 mt-1 font-bold">atau klik untuk menelusuri folder komputer (.pdf, .xlsx up to 10MB)</p>
                      </div>

                      {/* Upload Progress Simulation */}
                      {isUploading && (
                        <div className="mt-3 bg-teal-50 p-3 rounded border border-teal-200 mx-1">
                          <div className="flex justify-between items-center text-[10px] text-teal-900 font-bold mb-1">
                          ...
                          {uploadedFiles.map(f => (
                            <div key={f.name} className="flex items-center justify-between bg-emerald-50 border border-emerald-200 rounded p-2.5 mx-1">
                              <div className="flex items-center gap-2">
                                <span className="p-1 bg-emerald-200 text-emerald-800 rounded text-xs font-mono font-bold">PDF</span>
                                <div>
                              ...
                              {!isFieldDisabled && (
                                <button 
                                  ...
                                  className="text-[10px] text-red-600 hover:underline font-bold font-sans cursor-pointer"
                                >
                                  Hapus
                                </button>
                              )}
